...
button_algaja = tk.Button(main_frame, text="Algaja", font=("Arial", 18), command=lambda: näita_frame(algaja_frame))
button_algaja.grid(row=1, column=0, padx=20, pady=50)

button_edasijõudnud = tk.Button(main_frame, text="Edasijõudnud", font=("Arial", 18), command=lambda: näita_frame(edasijõudnud_frame))
